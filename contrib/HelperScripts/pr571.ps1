...
##                 https://color.org
#
# Last Modified: 02-FEB-2026 2243Z by David Hoyt
# Intent: Windows PR-571 Build Script
#
#
# iex (iwr -Uri "https://raw.githubusercontent.com/InternationalColorConsortium/iccDEV/refs/heads/research/contrib/HelperScripts/pr571.ps1").Content
#
#
#
###############################################################

Write-Host "============================= Starting Windows Build for PR-571 =============================" -ForegroundColor Green
Write-Host "Last Updated: 02-FEB-2026 2243Z by David H Hoyt LLC" -ForegroundColor Green
